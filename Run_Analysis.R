...
##
##
## columnbind data for test group using labels for volunteer##s and activities and data values
##
...
##   Volunteers or subjects idofwhatheyaredoing descriptiono##fehattheyaredoing tBodyAcc-mean()-X tBodyAcc-mean()-Y ##tBodyAcc-mean()-Z tBodyAcc-std()-X
...
##
##
write.table( tidydatatogether30 , file = "./averageactivitybysubjectrownamesequalfalse.txt " , row.names = FALSE)
##
##
##  dir()
